...
class BacktestService:
    ...
    def _build_summary_model(summary_data: Dict[str, Any]) -> BacktestSummary:
        return BacktestSummary(
            ...
            benchmark_coverage_pct=summary_data.get("benchmark_coverage_pct"),
            avg_excess_return_pct=summary_data.get("avg_excess_return_pct"),
            alpha_hit_rate_pct=summary_data.get("alpha_hit_rate_pct"),
            avg_cost_pct=summary_data.get("avg_cost_pct"),
            unfillable_rate_pct=summary_data.get("unfillable_rate_pct"),
            tradable_win_rate_pct=summary_data.get("tradable_win_rate_pct"),
    ...
    def _summary_to_dict(row: BacktestSummary) -> Dict[str, Any]:
        return {
            ...
            "benchmark_coverage_pct": row.benchmark_coverage_pct,
            "avg_excess_return_pct": row.avg_excess_return_pct,
            "alpha_hit_rate_pct": row.alpha_hit_rate_pct,
            "avg_cost_pct": row.avg_cost_pct,
            "unfillable_rate_pct": row.unfillable_rate_pct,
            "tradable_win_rate_pct": row.tradable_win_rate_pct,
